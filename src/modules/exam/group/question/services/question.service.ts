...
export class QuestionService {
  ...
  // ===== CRUD =====
  static async createQuestion(data: IQuestion, file?: ICloudinaryFile) {
    let parsed: any;
    try {
  ...
  static async updateQuestion(id: string, data: IQuestion) {
    this.assertObjectId(id, "معرف السؤال غير صالح");
  ...
  static async updateAnswers(id: string, data: IQuestion) {
    this.assertObjectId(id, "معرف السؤال غير صالح");
